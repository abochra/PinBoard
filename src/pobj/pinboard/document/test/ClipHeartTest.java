...
public class ClipHeartTest {
    
    @Test
    public void testNew() {
        Clip c = new ClipHeart(100., 200., 300., 400., Color.RED);
    ...
    public void testIsSelected() {
        ...
        assertFalse(c.isSelected(200., 500.));
        assertFalse(c.isSelected(0., 300.));
        assertFalse(c.isSelected(400., 300.));
    }
    ...
    public void testCopy() {
        Clip c = new ClipHeart(100., 200., 300., 400., Color.RED);
        Clip d = c.copy();
        assertTrue(d instanceof ClipHeart);
        c.move(1., 2.);
        c.setColor(Color.BLUE);
        assertEquals(101., c.getLeft(), 0.);
        assertEquals(202., c.getTop(), 0.);
